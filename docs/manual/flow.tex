...
\paragraph{Chord}  Reassigns high frequency partials in order to form an interval or chord.  The volume of additional chord notes (beyond the original root) is controlled by {\it Gain}.  Your {\it Chord} options are:
