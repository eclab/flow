...
\noindent {\Huge\bf {\name}}\\[0.5em]
{\large \bf An Open-source, Fully Modular, Polyphonic and Multitimbral, Additive Synthesizer\\[0.2em]
Version 3\\[0.2em]
...
Subpatches are added to the primary patch by choosing {\it Load Subpatch...} in the {\it File} menu.  You can remove a subpatch by clicking on its close box, just like removing a module.
...
Subpatches cannot themselves use MPE, nor can the be assigned to ``Any Channel''.  Only the primary patch can.
