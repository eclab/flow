...
The SQ-80 is unusual in that it had different versions of the same wave depending on the octave of the note played on the keyboard (for octaves 1--14).  Thus if you see a wave called {\tt SQ grit 12-13}, this means the harmonics of the ``grit'' wave for octaves 12 and 13.  This collection is incomplete: the original source has a few errors.\footnote{The SQ-80 harmonics are drawn from the waves in http:/\!/www.buchty.net/ensoniq/files/the\_waves.zip by //christian.}

The Prophet VS traditionally had waves 32--127, and these more or less line up with the harmonics provided by Flow: but you'll notice that Flow is missing a few.  The missing harmonics are partly because some of the waves are uninteresting (square waves, silence, etc.) and partly because my source is missing them.\footnote{The Prophet VS harmonics are drawn from https:/\!/www.dropbox.com/sh/ja0tc8wn6cnudzj/AACYqe2mjrWU2CeXIttm6MhOa as discussed in the forum thread http:/\!/www.muffwiggler.com/forum/viewtopic.php?t=33918\&sid=9e0b9554f0ac483b62a88c074c6136c3}
