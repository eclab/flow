...
public abstract class TuningDefinition
    {
        ...
        public JComponent getRootMIDINoteComponent()
            ...
            if (rootMIDINoteF == null)
                rootMIDINoteF =
                        new JTextField("" + Prefs.getLastXAsInt("rootMIDINote",
                                name, DEFAULT_ROOT_MIDI_NOTE));
        ...
        public JComponent getRootFrequencyComponent()
            ...
            rootFrequencyF =
                    new JTextField("" + Prefs.getLastXAsDouble("rootFrequency",
                            name, DEFAULT_ROOT_FREQUENCY));
            ...
            compute.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e)
                    ...
                    rootFrequencyF
                            .setText("" + TuningDefinition.midiNumberToHz(rmn));
                    }
            });
        ...
        public int getRootMeanNoteValue()
            ...
            try
                ...
                {
                rootMIDINoteF.setText("" + Prefs.getLastXAsInt("rootMIDINote",
                        name, DEFAULT_ROOT_MIDI_NOTE));
                return -1;
                }
            return rmn;
        ...
        public double getRootFrequencyValue()
            ...
            try
                ...
                {
                rootFrequencyF
                        .setText("" + Prefs.getLastXAsDouble("rootFrequency",
                                name, DEFAULT_ROOT_FREQUENCY));
                return -1;
                }
            return rf;
