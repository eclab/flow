...
public class StateVariableFilter extends Unit
    {
    ...
    public String getModulationValueDescription(int modulation, double value, boolean isConstant)
        ...
        if (isConstant)
            ...
            if (modulation == MOD_CUTOFF)
            	{
        		return String.format("%.4f", modToFrequency(makeInsensitive(value)));
            	}
    ...
    public ModulePanel getPanel()
        {
        return new ModulePanel(StateVariableFilter.this)
            {
