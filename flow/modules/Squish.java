...
/**
   A Unit which squishes the frequency of partials towards a specific numbered partial.
   The squishing function can be linear, squared, or cubed.  Additionally, if the
   function is not FREE, then the squishing is bounded so that the most extreme partials
   at each end stay fixed to their former positions; this has the effect of stretching the
   interior partials away from them in a sort of springlike fashion.
   
   The degree of squeezing is defined by the modulation AMOUNT (to which you might
...
public class Squish extends Unit
    {
    ...
    public void go()
        ...
        // compute the "in-between frequency"
        double targetFreq = 0;
