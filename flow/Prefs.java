...
public class Prefs {
    ...
    public static Preferences getAppPreferences(String module, String namespace) {
        return Preferences.userRoot()
            .node(EDITOR_PREFERENCES + "/" + module.replace('.', '/') + "/" + namespace.replace('.', '/'));
        }
    ...
    public static final String getLastX(String x, String moduleName) {
        if (moduleName != null) {
            ...
            if (prop != null) {
                ...
                return Prefs.getAppPreferences(moduleName, "data").get(x, null);
            } else
            return null;
        }
    ...
    public void setLastDirectory(String path) {
        setLastX(path, "LastDirectory");
        }

    /** Returns the last directory used by load, save, or save as */
    public String getLastDirectory() {
        return getLastX("LastDirectory");
        }

    // various cover methods for preferences used only by Output to store various
    // synth parameters

    public static void setLastNumVoices(int voices) {
        setLastX("" + voices, "Voices");
        }
    ...
    public static void setLastNumVoicesPerThread(int voicesPerThread) {
        setLastX("" + voicesPerThread, "VoicesPerThread");
        }
    ...
    public static void setLastNumOutputsPerThread(int outputsPerThread) {
        setLastX("" + outputsPerThread, "OutputsPerThread");
        }
    ...
    public static void setLastBufferSize(int bufferSize) {
        setLastX("" + bufferSize, "BufferSize");
        }
    ...
    public static void setLastMidiDevice(String midiDevice) {
        setLastX("" + midiDevice, "MidiDevice");
        }
    ...
    public static void setLastMidiDevice2(String midiDevice) {
        setLastX("" + midiDevice, "MidiDevice2");
        }
    ...
    public static void setLastChannel(int channel) {
        setLastX("" + channel, "Channel");
        }
    ...
    public static void setLastNumMPEChannels(int num) {
        setLastX("" + num, "NumMPEChannels");
        }
    ...
    public static void setLastNumPartials(int num) {
        setLastX("" + num, "NumPartials");
        }
    ...
    */
    ...
    public static void setWaterfallDisplay(boolean val) {
        setLastX("" + val, "WaterfallDisplay");
        }
    ...
    public static void setLogAxisDisplay(boolean val) {
        setLastX("" + val, "LogAxisDisplay");
        }
    ...
    public static void setMaxDisplayedHarmonic(int num) {
        setLastX("" + num, "MaxDisplayedHarmonic");
        }
    ...
    public static void setMinDisplayedHarmonic(int num) {
        setLastX("" + num, "MinDisplayedHarmonic");
        }
    ...
    public static void setLastOneVoice(boolean val) {
        setLastX("" + val, "OneVoice");
        }
    ...
    public static void setVelocitySensitive(boolean val) {
        setLastX("" + val, "VelocitySensitive");
        }
    ...
    public static void setRespondsToBend(boolean val) {
        setLastX("" + val, "RespondsToBend");
        }
    ...
    public static void setLastMIDISync(boolean val) {
        setLastX("" + val, "MIDISync");
        }
    ...
    public static void setLastAddModulesAfter(boolean val) {
        setLastX("" + val, "AddModulesAfter");
        }
    ...
    public static void setSwapPrimaryWithMIDIVoice(boolean val) {
        setLastX("" + val, "SwapPrimaryWithMIDIVoice");
        }
    ...
    public static void setLastAudioDevice(String audioDevice) {
        setLastX("" + audioDevice, "AudioDevice");
        }
    ...
    public static void setLastInputAudioDevice(String inputAudioDevice) {
        setLastX("" + inputAudioDevice, "InputAudioDevice");
        }
    ...
    public static void setLastMasterGain(double gain) {
        setLastX("" + gain, "MasterGain");
        }
    ...
    public static void setLastStereo(boolean val) {
        setLastX("" + val, "Stereo");
        }
    ...
    public static int getLastSinQuality() {
        String s = getLastX("SinQuality");
        try {
    ...
    public static void setLastSinQuality(int val) {
        setLastX("" + val, "SinQuality");
        }

    public static int getLastXAsInt(String slot, String moduleName, int defaultVal) {
        String tnls = getLastX(slot, moduleName);
        try {
    ...
    public static double getLastXAsDouble(String slot, String moduleName, double defaultVal) {
        String tnls = getLastX(slot, moduleName);
        try {
